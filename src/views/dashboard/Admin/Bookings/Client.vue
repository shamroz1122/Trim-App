       ...
       <v-layout row wrap class="pb-1">
        ...
        <v-layout row wrap class="pb-1">
         ...
         <v-layout row wrap class="pb-1">
          ...
          <v-divider></v-divider>
          <v-layout v-if="completed" row wrap class="pt-1">
              <v-flex xs10 md6 sm6 class="mt-1">
                <span class="current-date"> Completed  </span>
              </v-flex>
              <v-flex xs2 md6 sm6 text-xs-right class="mt-1">
                <span class="current-date"> <font-awesome-icon style="color:#5BBC52" class="back-link" large   :icon="['fas','check-circle']"/>  </span>
              </v-flex>
