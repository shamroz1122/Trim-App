      ...
      >
        <v-layout row wrap text-xs-center>
          <v-flex  xs2 md2 sm2  style="text-align:left;">
              <router-link class="help-btn"  :to="{ name: 'BarberSettings', params: {} }">  <font-awesome-icon class="back-link"   :icon="['fas','arrow-left']"/></router-link>
                ...
                <v-card-text style="padding: 10%;">
                  <div class="title"> Change Password </div>
                   ...
                   ></v-text-field>
                     ...
                     <v-btn class="login-btn" block depressed >Update Password</v-btn>
